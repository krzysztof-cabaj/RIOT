...
/**
 * @brief   PIO I2C object type
 */
typedef struct pio_i2c_obj {
    pio_t pio;              /**< PIO index */
    pio_sm_t sm;            /**< State machine index */
    pio_program_i2c_t pro;  /**< PIO I2C program */
} pio_i2c_obj_t;
...
/**
 * @brief   Initialize PIO I2C pins and programs configured with PIO_I2C_CONFIG
 *
 * @note    No program initialization is performed if
